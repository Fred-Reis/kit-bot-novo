...
const FIELD_CLS =
  'w-full rounded border border-border bg-background px-3 py-1.5 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-primary/40';
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="px-5 py-3 text-left text-xs font-medium text-muted-foreground hidden lg:table-cell">
                  Valor
                </th>
                <th className="px-5 py-3 text-left text-xs font-medium text-muted-foreground">
                  Status
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5 text-xs text-muted-foreground hidden lg:table-cell">
                      {formatCurrency(c.monthlyRent)}/mês
                    </td>
